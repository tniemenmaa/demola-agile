...
function getShellFrameStartedHandler( shellFrame ) {
	...
	return function() {
		...
		if( shellFrame.CurrentPath == "" ) {
			...
			//var homeTab = shellFrame.RightPane.AddTab( "test", "test application", "_last" );  // The string id 27664 is allocated from the resource-id space, which is mainly used through enumeration from localization.js. This is an exception.
			//homeTab.ShowDashboard( "home", null );
